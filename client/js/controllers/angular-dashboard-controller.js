app.controller('dashboardController', ['$scope', 'userFactory', 'hikeFactory', 'userMessages', '$location', '$routeParams', '$anchorScroll', function($scope, userFactory, hikeFactory, userMessages, $location, $routeParams, $anchorScroll) {
  ...
  */
  ...
  $scope.startPreTrip = function(hikeId) {
    ...
    } else { // Otherwise load pre-trip page for hikeId:
  ...
  $scope.welcomeAlerts = [{
    type: 'info',
    hdr: 'Instructions:',
    msg: 'Add a New Hike below. Prepare for your trip by completing a Pre-Trip report. When you return, complete a Post-Trip report. View your full report to improve with each experience!'
  }];
  ...
  $scope.infoAlerts = [{
    type: 'success',
    hdr: 'New Feature! 💝',
    msg: 'Now you can edit or modify the date of your hike in your Post-Trip form!'
  }];
